...
export const mockEquipmentDefinitions: EquipmentDefinition[] = [
  ...
  },
  {
    ...
    dimensionsMm: { width: 835, depth: 130, height: 280 },
    serviceClearancesMm: { front: 150, back: 150, left: 150, right: 150 },
    connectionPoints: [
      { id: "supply-main", type: "supply", label: "Вход коллектора подачи DN32", position: { xMm: 0, yMm: 65, zMm: 1200 }, nominalDiameterMm: 32, direction: "left", systemRole: "target", source: "manufacturer_catalog", confidence: 0.65 },
      { id: "supply-out-1", type: "supply", label: "Выход контура 1 DN25", position: { xMm: 355, yMm: 0, zMm: 1200 }, nominalDiameterMm: 25, direction: "top", systemRole: "source", source: "manufacturer_catalog", confidence: 0.55 },
      { id: "supply-out-2", type: "supply", label: "Выход контура 2 DN25", position: { xMm: 480, yMm: 0, zMm: 1200 }, nominalDiameterMm: 25, direction: "top", systemRole: "source", source: "manufacturer_catalog", confidence: 0.55 },
    ],
    metadata: {
      ...
      extractedFacts: {
        ...
        nominalPressureBar: 4,
        maxTemperatureC: 110,
        maxFlowM3H: 6.5,
      },
      notes: "Габариты L=835 мм, H=280 мм и резьбы G2 подтверждаются техническим паспортом STOUT от 30.03.2023. Координаты патрубков в модели выведены по таблице габаритов и требуют сверки по заводскому чертежу/схеме.",
    },
    source: "manufacturer_catalog",
  },
  {
    ...
    serviceClearancesMm: { front: 150, back: 150, left: 150, right: 150 },
    connectionPoints: [
      { id: "return-main", type: "return", label: "Вход коллектора обратки DN32", position: { xMm: 0, yMm: 65, zMm: 1200 }, nominalDiameterMm: 32, direction: "left", systemRole: "target", source: "manufacturer_catalog", confidence: 0.65 },
      { id: "return-out-1", type: "return", label: "Выход контура 1 DN25", position: { xMm: 355, yMm: 130, zMm: 1200 }, nominalDiameterMm: 25, direction: "bottom", systemRole: "source", source: "manufacturer_catalog", confidence: 0.55 },
      { id: "return-out-2", type: "return", label: "Выход контура 2 DN25", position: { xMm: 480, yMm: 130, zMm: 1200 }, nominalDiameterMm: 25, direction: "bottom", systemRole: "source", source: "manufacturer_catalog", confidence: 0.55 },
    ],
    metadata: {
      sourceDocumentId: "src-stout-steel-manifold-dn32",
      reviewStatus: "review_required",
  ...
  },
  {
    ...
    manufacturer: "DN",
    model: "BV3232P(2PC)-FP-F-ISO-H",
    dimensionsMm: { width: 165, depth: 78, height: 130 },
    ...
    metadata: {
      ...
      notes: "Публичный паспорт серии BV3232P подтверждает типоразмер Ду32, Ру40 и применение в системах теплоснабжения. Для проекта всё ещё требуется инженерный выбор способа присоединения и серии.",
    },
    source: "manufacturer_catalog",
  },
  {
  ...
  },
  {
    ...
    metadata: {
      ...
      notes: "Публичный паспорт серии BV3232P подтверждает типоразмер Ду25 и диапазон температур. Для проекта всё ещё требуется инженерный выбор газовой арматуры и способа присоединения.",
    },
    source: "manufacturer_catalog",
  },
];
